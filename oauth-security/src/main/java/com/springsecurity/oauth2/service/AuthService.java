...
import com.springsecurity.oauth2.config.jwtConfig.JwtTokenGenerator;
import com.springsecurity.oauth2.dto.AuthResponseDto;
import com.springsecurity.oauth2.dto.TokenType;
import com.springsecurity.oauth2.dto.UserRegistrationDto;
import com.springsecurity.oauth2.entity.RefreshTokenEntity;
import com.springsecurity.oauth2.entity.UserInfoEntity;
import com.springsecurity.oauth2.mapper.UserInfoMapper;
...
public class AuthService {
    ...
    public AuthResponseDto registerUser(UserRegistrationDto userRegistrationDto,HttpServletResponse httpServletResponse){
        ...
        try{
            ...
            Optional<UserInfoEntity> user = userInfoRepo.findByEmailId(userRegistrationDto.correo());
            if(user.isPresent()){
